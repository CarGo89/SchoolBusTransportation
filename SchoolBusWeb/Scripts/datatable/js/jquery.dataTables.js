        ...
        function _fnGetRowElements(settings, row, colIdx, d) {
            ...
            var cellProcess = function (cell) {
                if (colIdx === undefined || colIdx === i) {
                    ...
                    if (col && col.avoidSearchHiddenElements === true) {
                        var cellWithoutHiddenControls = $(cell).clone(true);

                        cellWithoutHiddenControls.children(".hidden").remove();

                        contents = $.trim(cellWithoutHiddenControls.get(0).innerHTML);
                    }
                    else {
